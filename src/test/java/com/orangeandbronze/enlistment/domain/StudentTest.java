...
public class StudentTest {
	...
	public void enlistFirstSection() {
		...
		Section section = new Section("abc123", SCHEDULE, room, SUBJECT_NO_PREREQ);
	...
	public void enlistSectionsSameSchedule() {
		Room room = new Room("R101", 10);
		Student student = new Student(1);
		Section s1 = new Section("A", SCHEDULE, room, SUBJECT_NO_PREREQ);
		Section s2 = new Section("B", SCHEDULE, room, SUBJECT_NO_PREREQ);
		student.enlist(s1);
		student.enlist(s2);
	}
	...
	public void enlist3StudentsInSameSection(){
		...
		Section section = new Section("A", SCHEDULE, room1, SUBJECT_NO_PREREQ);
